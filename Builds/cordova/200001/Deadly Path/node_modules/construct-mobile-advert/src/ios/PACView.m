...
//    return;
//  }
  // HACK: (appears to be originally added by Iain) Custom way for loading consent form HTML in Cordova
  NSURL *URL = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"consentform" ofType:@"html"]];
